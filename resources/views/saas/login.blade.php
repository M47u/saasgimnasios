...
<head>
    ...
    <title>Panel Administrador — SaaS Gimnasios</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css" rel="stylesheet">
    <style>
        body {
            background: linear-gradient(135deg, #1e1b3a 0%, #534AB7 100%);
            min-height: 100vh;
        ...
        .form-control:focus { border-color: #534AB7; box-shadow: 0 0 0 .25rem rgba(83,74,183,.25); }
        .btn-login {
            background: #534AB7; color: #fff; width: 100%;
            padding: .75rem; font-weight: 600; border: none; border-radius: 8px;
        }
        .btn-login:hover { background: #3d368a; color: #fff; }
    </style>
</head>
<body>
    <div class="login-card card">
        <div class="login-header">
            ...
            <h4 class="mb-0 fw-bold">Panel Administrador</h4>
            <p class="mb-0 opacity-75 small mt-1">SaaS Gimnasios</p>
        </div>
